---
description: Deterministic Nuxt 4 SEO optimization workflow. Audits the entire codebase, installs the Nuxt SEO stack, enforces SSR metadata, canonicalization, sitemap coverage, structured data, internal linking, and Core Web Vitals.
---
